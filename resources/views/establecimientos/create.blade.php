        ...
        <div class="mt-5 row justify-content-center">
            ...
            @csrf
                ...
                <fieldset class="border p-4 mt-5">
                    <legend class="text-primary">Ubicacioón</legend>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            class="form-control"
                        >
                        <p class="text-secondary mt-5 mb-3 text-center">El asistente colocará una direccion estimada, mueve el Pin hacía el lugar correcto</p>
                    </div>
